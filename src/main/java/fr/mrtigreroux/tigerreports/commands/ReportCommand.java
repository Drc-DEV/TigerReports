                ...
                if (result != null) {
                    try {
                        ...
                        if (reporterUuid.contains(uuid)) {
                            Bukkit.getScheduler().runTask(tr, () -> MessageUtils.sendErrorMessage(p,
                    ...
                    if (!maxReportsReached) {
                        ...
                        Bukkit.getScheduler().runTaskAsynchronously(tr, () -> {
                            int reportId1 = db.insert(
                                    ...
                                    parameters);
                            Bukkit.getScheduler().runTask(tr, () -> finalReportCommandProcess(
                                    new Report(reportId1, Status.WAITING.getConfigWord(), "None",
